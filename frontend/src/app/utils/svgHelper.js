...
export function drawSVG(dom_id, url ='http://od843aa4c.bkt.clouddn.com/hongwu/040.jpg') {

  var drawing = window.drawing = new SVG(dom_id).viewbox(0,0, 1200, 1680);
...
export function drawLines(draw, list_lines) {
...
export function highlightColumn(draw, objects, line_no) {
  objects[line_no-1].col[0].addClass("highlight-11");
  objects[line_no].col[0].addClass("highlight-11");
}


export function cleanCutContent(drawing){
